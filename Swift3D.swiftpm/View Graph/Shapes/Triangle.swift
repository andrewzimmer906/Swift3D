...
extension Triangle where Geometry == StandardGeometry {
  static func get() -> Geometry {
    StandardGeometry(vertices: [
      .init(position: simd_float3(x: 0, y: 1, z: 0), uv: simd_float2(x: 0.5, y: 1), normal: .forward),
      .init(position: simd_float3(x: -1, y: -1, z: 0), uv: simd_float2(x: 0, y: 0), normal: .forward),
      .init(position: simd_float3(x: 1, y: -1, z: 0), uv: simd_float2(x: 1, y: 0),  normal: .forward)    
    ], indices: [0,1,2])
  }
}
